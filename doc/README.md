...
## First config (Developper)

    1. npx ampx configure profile
    2. npx ampx sandbox
    3. download amplify_outputs.json
    4. paste it above to the root of your project

https://docs.amplify.aws/vue/start/quickstart/#deploy-a-fullstack-app-to-aws
